            ...
            <div className="container">
                <div className="row align-items-center">
                    <div className="col-5 col-md-2">
                        <a href="/" className="pxp-logo text-decoration-none"><img src={Logo} alt="rojkindLogo"/></a>
                    </div>
                ...
                <a href={e => e.preventDefault()} className="pxp-header-nav-trigger" onClick={toggle}>
